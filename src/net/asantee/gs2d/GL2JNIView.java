...
public class GL2JNIView extends GLSurfaceView {
	...
	public GL2JNIView(GS2DActivity activity, String apkPath, SoundCommandListener soundCmdListener, AccelerometerListener accelerometerListener,
	...
	private void init(boolean translucent, int depth, int stencil, GS2DActivity activity) {
		...
		setRenderer(new Renderer(apkPath, soundCmdListener, mediaStreamListener, customListener, activity));
	}
	...
	private static class Renderer implements GLSurfaceView.Renderer {
		...
		Renderer(String apkPath, SoundCommandListener cmdListener, MediaStreamListener mediaStreamListener, NativeCommandListener customListener, GS2DActivity activity) {
			this.apkPath = apkPath;
